...
cheatas.StoryCard.prototype =
{
	...
	create: function()
	{
		...
		{
			that.handleEvent(e, cheatas.config.ACTION_LOAD_TIMELINE_DATA);
		}
	...
	createTags: function()
	{
		...
		{
			that.handleEvent(e, cheatas.config.ACTION_SORT_DATA_BY_KEYWORD);
		}
	...
	createPage: function(div, dr)
	{
		...
		function loadDataComplete(e)
		{
			...
			that.loading(false);
			that.handleEvent(e, cheatas.config.ACTION_LOAD_DATA_COMPLETE);
		}
	...
	handleEvent: function(e, a, param)
	{
		cheatas.debugger.log("Event",
			[
				"cheatas.StoryCard.handleEvent(e)",
				"e = " + e,
				"a = " + a,
				"param = " + param
			]
	...
	handleEventComplete: function(e, a, param, x, y)
	{
