...
cheatas.UISlideBox.prototype = 
{
	...
	moveSlide: function(direction) 
	{
		...
		cheatas.animation.startAnimation(this.nodes.view.style, {listener: this.nodes.view, staticProp: true, duration: this.slideSpd, left: tx, ease: easev , isPx: true}, new aniDelegate()); // cheatas.AnimationCSS 사용
		// cheatas.animation.startAnimation(this.nodes.view, {listener: null, staticProp: true, duration: this.slideSpd, left: tx, ease: easev , isPx: true}, new aniDelegate()); // cheatas.AnimationJS 사용
	},
