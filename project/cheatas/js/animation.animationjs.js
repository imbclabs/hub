...
cheatas.AnimationJS.prototype =
{
	startAnimation: function(element, aniObj) 
	{
		cheatas.debugger.log("Function",
			[
				"cheatas.animationJS.startAnimation(element, aniObj)",
				"element = " + element,
				"aniObj = " + aniObj
			]
		);
    ...
    loof: function() 
	{
		cheatas.debugger.log("Function", "cheatas.animationJS.loof()");
	...
	{
		cheatas.debugger.log("Function", "cheatas.animationJS.addLoofTimer()");
		...
		cheatas.debugger.trace(
			[
				"cheatas.animationJS.addLoofTimer()",
				"this.fps = " + this.fps,
				"t = " + t
			]
		);

		this.loofTimer = setTimeout(function() {that.loof();}, t);
	},
