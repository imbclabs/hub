			  ...
			  [  
				 {
				  ...
				  option:{
							...
							pageTopOption:{
											...
											bgMA:["radio-head.jpg","radio-head1.jpg"],
				 ...
				 },
				 {
				  ...
				  option:{
						   title:"심심타파 사진방",
						   apiPath:"http://vodmall.imbc.com/api/RadioBoardList.aspx?page=2&pagesize=20&groupid=11&bid=simsim79",
						   type:"PHOTO",
						   reciveKey:"PhotoList"
						 }
				 },
				 {
				  ...
				  hasShadow:null,
				  option:{
						   apiPath:"http://vodmall.imbc.com/api/RadioBoraList.aspx?page=1&pagesize=20&groupid=8&programcd=1000664100000100000",
						   title:"심심타파 동영상",
						   type:"VOD",
						   reciveKey:"VideoList"
						 }
				 ...
				 },
				 {
					...
					option:{
						cssTxtColor:"#ffffff",
						isFullMode:true,
					    sms:"SMS 문자 참여 #8000  정보이용료 SMS: 50원,  MMS: 100원 (통화료 별도)",
						addr:"우편번호 : (150-604) 서울 여의도 우체국 사서함 819호 <심심타파> 담당자앞",
						tunein:"14585"
